    ...
    buttons: [
      [{
        ...
        data: [{
          ...
          hotkey: 'Ctrl+B',
          title: 'Bold',
          icon: { glyph: 'glyphicon glyphicon-bold', fa: 'fas fa-bold', 'fa-3': 'icon-bold' },
          callback: function(e){
          ...
          title: 'Italic',
          hotkey: 'Ctrl+I',
          icon: { glyph: 'glyphicon glyphicon-italic', fa: 'fas fa-italic', 'fa-3': 'icon-italic' },
          callback: function(e){
            // Give/remove * surround the selection
            var chunk, cursor, selected = e.getSelection(), content = e.getContent()
          ...
          title: 'Heading',
          hotkey: 'Ctrl+H',
          icon: { glyph: 'glyphicon glyphicon-header', fa: 'fas fa-font', 'fa-3': 'icon-font' },
          callback: function(e){
        ...
        data: [{
          ...
          title: 'URL/Link',
          hotkey: 'Ctrl+L',
          icon: { glyph: 'glyphicon glyphicon-link', fa: 'fas fa-link', 'fa-3': 'icon-link' },
          callback: function(e){
          ...
          title: 'Image',
          hotkey: 'Ctrl+G',
          icon: { glyph: 'glyphicon glyphicon-picture', fa: 'fas fa-picture-o', 'fa-3': 'icon-picture' },
          callback: function(e){
        ...
        data: [{
          ...
          icon: { glyph: 'glyphicon glyphicon-list', fa: 'fas fa-list', 'fa-3': 'icon-list-ul' },
          callback: function(e){
        ...
        },
        {
          ...
          hotkey: 'Ctrl+O',
          title: 'Ordered List',
          icon: { glyph: 'glyphicon glyphicon-th-list', fa: 'fas fa-list-ol', 'fa-3': 'icon-list-ol' },
          callback: function(e) {
        ...
        },
        {
          ...
          hotkey: 'Ctrl+K',
          title: 'Code',
          icon: { glyph: 'glyphicon glyphicon-asterisk', fa: 'fas fa-code', 'fa-3': 'icon-code' },
          callback: function(e) {
        ...
        },
        {
          ...
          hotkey: 'Ctrl+Q',
          title: 'Quote',
          icon: { glyph: 'glyphicon glyphicon-comment', fa: 'fas fa-quote-left', 'fa-3': 'icon-quote-left' },
          callback: function(e) {
            // Prepend/Give - surround the selection
            var chunk, cursor, selected = e.getSelection(), content = e.getContent()
        ...
        data: [{
          ...
          icon: { glyph: 'glyphicon glyphicon-search', fa: 'fas fa-search', 'fa-3': 'icon-search' },
          callback: function(e){

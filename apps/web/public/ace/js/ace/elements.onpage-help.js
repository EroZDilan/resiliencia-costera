window.Onpage_Help = function(options) {
	...
	var defaults = {
		include_all: true,
		icon_1: 'fas fa-question',
		icon_2: 'fas fa-lightbulb-o',
		base: '',
	...
	function launch_help_modal(section_name, save_to_list) {
				...
				<div class="modal-content">\
					<div class="modal-header">\
					  <div class="pull-right onpage-help-modal-buttons">\
						<button aria-hidden="true" data-navdir="up" type="button" class="disabled btn btn-white btn-success btn-sm"><i class="ace-icon fas fa-level-up fa-flip-horizontal bigger-125 icon-only"></i></button>\
						&nbsp;\
						<button aria-hidden="true" data-navdir="back" type="button" class="disabled btn btn-white btn-info btn-sm"><i class="ace-icon fas fa-arrow-left icon-only"></i></button>\
						<button aria-hidden="true" data-navdir="forward" type="button" class="disabled btn btn-white btn-info  btn-sm"><i class="ace-icon fas fa-arrow-right icon-only"></i></button>\
						&nbsp;\
						<button aria-hidden="true" data-dismiss="modal" class="btn btn-white btn-danger btn-sm" type="button"><i class="ace-icon fas fa-times icon-only"></i></button>\
					  </div>\
		...
		help_modal.find('.modal-title').wrapInner("<span class='hidden' />").append('<i class="fas fa-spinner fa-spin blue bigger-125"></i>');
		...
		.done(function(result) {
			...
			if(_.settings.add_panels) {
				...
				content.find('.panel').each(function() {
					...
					.append('<i class="pull-right ace-icon fas fa-plus" data-icon-show="ace-icon fas fa-plus" data-icon-hide="ace-icon fas fa-minus"></i>')

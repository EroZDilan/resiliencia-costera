...
//			this.$element.trigger('changed.fu.spinbox', this.output(currentValue, false)); // no DOM update
			this.$input.trigger('changed.fu.spinbox', this.output(currentValue, false)); // no DOM update
		},
		...
		step: function(isIncrease) {
			...
			if ( (isIncrease ? currentValue < limitValue : currentValue > limitValue) ) {
                ...
                min: function(min) { //added by Willy
                    this.options.min = min;
                    this.options.value = this.checkMaxMin(this.options.value);
                    this.change();
                }, 
                
                max: function(max) { //added by Willy

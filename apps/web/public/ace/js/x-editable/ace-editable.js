...
(function ($) {
    ...
    ADate.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl:'<div class="input-group input-group-compact"><input type="text" class="input-medium date" /><span class="input-group-addon"><i class="fas fa-calendar"></i></span></div>',
		date: {
			weekStart: 0,
            startView: 0,
            minViewMode: 0

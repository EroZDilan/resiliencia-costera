    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return this.nonSelectedText + ' <b class="fas fa-caret-down"></b>';//ACE
                }
                else if (options.length == $('option', $(select)).length) {
                    return this.allSelectedText + ' <b class="fas fa-caret-down"></b>';//ACE
                }
                else if (options.length > this.numberDisplayed) {
                    return options.length + ' ' + this.nSelectedText + ' <b class="fas fa-caret-down"></b>';//ACE
                }
                else {
                    var selected = '';
                    ...
                    return selected.substr(0, selected.length - 2) + ' <b class="fas fa-caret-down"></b>';//ACE
                }
            },
            /**

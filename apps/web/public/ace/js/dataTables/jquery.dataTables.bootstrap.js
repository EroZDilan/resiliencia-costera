	...
	$.extend( $.fn.dataTableExt.oPagination, {
		"bootstrap": {
			"fnInit": function( oSettings, nPaging, fnDraw ) {
				...
				$(nPaging).append(
					'<ul class="pagination">'+
						'<li class="prev disabled"><a href="#"><i class="fas fa-angle-double-left"></i></a></li>'+//first
						'<li class="prev disabled"><a href="#"><i class="fas fa-angle-left"></i></a></li>'+//next
						'<li class="next disabled"><a href="#"><i class="fas fa-angle-right"></i></a></li>'+//prev
						'<li class="next disabled"><a href="#"><i class="fas fa-angle-double-right"></i></a></li>'+//last
					'</ul>'
				);
				var els = $('a', nPaging);

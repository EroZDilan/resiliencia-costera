...
(function($ , undefined) {
	...
	$.fn.aceAjax.defaults = $.fn.ace_ajax.defaults = {
		content_url: false,
		default_url: false,
		loading_icon: 'fas fa-spin fa-spinner fa-2x orange',
		loading_text: '',
...
(function($ , undefined) {
	...
	var Widget_Box = function(box, options) {
		...
		this.reload = function() {
			...
			$box.append('<div class="widget-box-overlay"><i class="'+ ace.vars['icon'] + 'loading-icon fas fa-spinner fa-spin fa-2x white"></i></div>');

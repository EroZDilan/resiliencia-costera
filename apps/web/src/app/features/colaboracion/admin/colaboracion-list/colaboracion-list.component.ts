...
@Component({
  selector: 'app-colaboracion-list',
  standalone: true,
  ...
  template: `
    ...
    <div class="admin-header">
      ...
      <button pButton label="Nueva" icon="pi pi-plus" routerLink="/admin/colaboraciones/nueva"></button>
    </div>
      ...
      <ng-template pTemplate="body" let-item>
        <tr>
          ...
          <td class="admin-actions">
            <button pButton icon="pi pi-pencil" class="p-button-text" [routerLink]="['/admin/colaboraciones', item.id]"></button>
...
export class ColaboracionListComponent implements OnInit {
  ...
  confirmRemove(item: Colaboracion): void {
